...
const NAME_PRICE_IMGURL_CATEGORY_REQUIRED = 'A name, price, category and imageUrl are required';
...
export { SIGN_UP_ERR_MSG, USER_WITH_EMAIL_EXISTS_MSG, NO_JWT_SECRET_MSG, NO_JWT_EXPIRY_TIME_MSG,NO_EMPTY_FIELD, 
    ...
    RESET_PASSWORD_ERR,IMAGE_UPLOAD_ERROR,LIMIT_FILE_SIZE_ERROR,WRONG_IMG_MIME,NO_IMAGE_PROVIDED,NAME_PRICE_IMGURL_CATEGORY_REQUIRED,
    ...
    PRODUCT_ID_AND_USER_ID_QUANTITY_REQUIRED,ERROR_ADDING_TO_CART,ERROR_FETCHING_CART,ERROR_DELETING_CART};